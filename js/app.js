                ...
                post.details.length > 180
                  ...
                  <div class="flex flex-auto pt-3">
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                             ...
                             <div class=" flex"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                          ...
                          <label onclick=showDetails(${
                            post._id
                          }) for="my-modal-6" class="btn modal-button"> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
const showDetails = async () => {
  const details = await relativePost();
};
