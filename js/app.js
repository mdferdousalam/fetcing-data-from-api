              ...
              <p>${
                post.details.length > 180
                  ...
                  <div class="flex flex-auto pt-3">
                          ...
                          <label  for="my-modal-6" class="mx-auto  pt-2 btn modal-button"> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
const showDetails = () => {
  console.log("clicked categoryPost");
};
